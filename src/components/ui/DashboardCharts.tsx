      ...
      <div className="bg-slate-800 rounded-xl p-5 border border-slate-700">
        ...
        <ResponsiveContainer width="100%" height={250}>
          <BarChart data={transactionsChartData}>
            ...
            />
            <Bar dataKey="count" fill="#4f46e5" radius={[4, 4, 0, 0]} name="Transações" />
          </BarChart>
        </ResponsiveContainer>
      </div>
        ...
        <ResponsiveContainer width="100%" height={250}>
          <LineChart data={revenueChartData}>
            ...
            <Tooltip
              ...
              labelStyle={{ color: '#fff' }}
              itemStyle={{ color: '#94a3b8' }}
              formatter={(value) => value != null ? [`R$ ${Number(value).toFixed(2)}`, 'Receita'] : ['', '']}
            />
            <Line type="monotone" dataKey="amount" stroke="#10b981" strokeWidth={2} dot={{ fill: '#10b981' }} name="Receita" />
          </LineChart>
        </ResponsiveContainer>
      </div>
